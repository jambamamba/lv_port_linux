...
public:
  LeleView(LeleObject *parent, const std::string &json_str);
...
public:
  LeleViewHeader(LeleObject *parent, const std::string &json_str);
  virtual bool fromJson(const std::string &json_str) override;
...
public:
  LeleViews(LeleObject *parent, const std::string &json_str);
  virtual bool fromJson(const std::string &json_str) override;
  virtual lv_obj_t *createLvObj(LeleObject *lele_parent = nullptr, lv_obj_t *lv_obj = nullptr) override;
  int count() const;
